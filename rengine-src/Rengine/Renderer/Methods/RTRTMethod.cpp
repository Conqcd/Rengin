...
template <>
void RTRTMethod::AddResource<Ref<Shader>,Ref<Shader>>(const Ref<Shader>& base,const Ref<Shader>& shadow,const Ref<Shader>& GShader) {
    m_BaseShader = base;
...
template <>
void RTRTMethod::AddResource<Ref<FrameBuffer>,Ref<FrameBuffer>>(const Ref<FrameBuffer>& GBuffer,const Ref<FrameBuffer>& Shadow,const Ref<FrameBuffer>& Main) {
    m_ShadowMap = Shadow;
    m_GBuffer = GBuffer;
    m_MainFrame = Main;
}
